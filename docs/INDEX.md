...
| [DEPLOY_UAT.md](./DEPLOY_UAT.md) | Hosting UAT gratis di Render + Supabase: kenapa bukan Netlify/Cloudflare, batas free tier yang akan terasa, enam file yang berubah, urutan deploy + migrasi + seed, dan jalan keluar kalau 512 MB kurang |
